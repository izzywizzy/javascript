...
export function remainingMinutesInOven(actualMinutesInOven) {
  ...
  var theNumberOfMinutesRemaining = EXPECTED_MINUTES_IN_OVEN - actualMinutesInOven ;

        

          

  return theNumberOfMinutesRemaining; 
...
export function preparationTimeInMinutes(numberOfLayers) {
  ...
  var minuesSpentInPreparing = numberOfLayers * PREPARATION_MINUTES_PER_LAYER ;

        

          

  return minuesSpentInPreparing ;
...
export function totalTimeInMinutes(numberOfLayers, actualMinutesInOven) {          
  ...
  var timeSpent = actualMinutesInOven + preparationTimeInMinutes(numberOfLayers) ;       
